            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">教室登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>教学楼</label>
                                    <input style="width: 450px" id="jiaoxuelouValue" name="jiaoxuelouValue" class="form-control"
                                           v-model="ruleForm.jiaoxuelouValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jiaoshiAddress" name="jiaoshiAddress" class="form-control"
                                               v-model="ruleForm.jiaoshiAddress" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.jiaoshiContent != null && ruleForm.jiaoshiContent != 'null' && ruleForm.jiaoshiContent != '') {
            var jiaoshiContentUeditor = UE.getEditor('jiaoshiContentEditor');
                jiaoshiContentUeditor.ready(function () {
                    ...
                    jiaoshiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
