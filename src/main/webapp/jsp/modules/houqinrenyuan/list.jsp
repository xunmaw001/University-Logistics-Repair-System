...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">后勤人员管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">后勤人员列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">后勤人员列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="gongsiTypesSelectSearch"  style="width: 150px;" id="gongsiTypesSelectSearch" class="form-control form-control-sm"
    ...
    <!-- 本表的查询条件 -->
        ...
        function getDataList() {
            http("houqinrenyuan/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                houqinrenyuanDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //公司
            var gongsiTypesCell = document.createElement('td');
            gongsiTypesCell.innerHTML = item.gongsiValue;
            row.appendChild(gongsiTypesCell);
            ...
            //后勤人员身份证号
            var houqinrenyuanIdNumberCell = document.createElement('td');
            houqinrenyuanIdNumberCell.innerHTML = item.houqinrenyuanIdNumber;
            row.appendChild(houqinrenyuanIdNumberCell);
            ...
            //电子邮箱
            var houqinrenyuanEmailCell = document.createElement('td');
            houqinrenyuanEmailCell.innerHTML = item.houqinrenyuanEmail;
            row.appendChild(houqinrenyuanEmailCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("houqinrenyuan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addhouqinrenyuan", "addhouqinrenyuan");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("houqinrenyuan/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
                    getDataList();
