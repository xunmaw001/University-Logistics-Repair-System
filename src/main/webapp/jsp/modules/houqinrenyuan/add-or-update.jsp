    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑后勤人员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">后勤人员管理</li>
                        <li class="breadcrumb-item active">编辑后勤人员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">后勤人员信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 gongsiTypesDiv">
                                        <label>公司</label>
                                        <select style="width: 450px" id="gongsiTypesSelect" name="gongsiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6 houqinrenyuanNameDiv">
                                        <label>后勤人员姓名</label>
                                        <input style="width: 450px" id="houqinrenyuanName" name="houqinrenyuanName" class="form-control"
                                               placeholder="后勤人员姓名">
                                    </div>
                                    <div class="form-group col-md-6 houqinrenyuanPhoneDiv">
                                        <label>后勤人员手机号</label>
                                    ...
                                    <div class="form-group col-md-6 houqinrenyuanIdNumberDiv">
                                        <label>后勤人员身份证号</label>
                                        <input style="width: 450px" id="houqinrenyuanIdNumber" name="houqinrenyuanIdNumber" class="form-control"
                                               onchange="houqinrenyuanIdNumberChickValue(this)"  placeholder="后勤人员身份证号">
                                    </div>
                                    <div class="form-group col-md-6 houqinrenyuanPhotoDiv">
                                        <label>后勤人员头像</label>
                                        <img id="houqinrenyuanPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="houqinrenyuanPhotoupload"
                                               class="form-control-file">
                                        <input name="houqinrenyuanPhoto" id="houqinrenyuanPhoto-input" type="hidden">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 houqinrenyuanEmailDiv">
                                        <label>电子邮箱</label>
                                        <input style="width: 450px" id="houqinrenyuanEmail" name="houqinrenyuanEmail" class="form-control"
                                               placeholder="电子邮箱">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("houqinrenyuan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addhouqinrenyuan');
    ...
    function setSelectOption() {
        ...
        if(gongsiTypesSelect != null && gongsiTypesOptions != null  && gongsiTypesOptions.length > 0 ) {
            for (var i = 0; i < gongsiTypesOptions.length; i++) {
                if (gongsiTypesOptions[i].codeIndex == ruleForm.gongsiTypes) {//下拉框value对比,如果一致就赋值汉字
                        gongsiTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    // 获取当前详情
    function getDetails() {
        var addhouqinrenyuan = window.sessionStorage.getItem("addhouqinrenyuan");
        if (addhouqinrenyuan != null && addhouqinrenyuan != "" && addhouqinrenyuan != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("houqinrenyuan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
