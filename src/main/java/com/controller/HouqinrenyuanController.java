...
//                            houqinrenyuanEntity.setGongsiTypes(Integer.valueOf(data.get(0)));   //公司 要改的
...
//                            houqinrenyuanEntity.setHouqinrenyuanPhoto("");//详情和图片
//                            houqinrenyuanEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            houqinrenyuanEntity.setHouqinrenyuanEmail(data.get(0));                    //电子邮箱 要改的
//                            houqinrenyuanEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //账户
                        List<HouqinrenyuanEntity> houqinrenyuanEntities_username = houqinrenyuanService.selectList(new EntityWrapper<HouqinrenyuanEntity>().in("username", seachFields.get("username")));
                        if(houqinrenyuanEntities_username.size() >0 ){
                         ...
                         //后勤人员手机号
                        List<HouqinrenyuanEntity> houqinrenyuanEntities_houqinrenyuanPhone = houqinrenyuanService.selectList(new EntityWrapper<HouqinrenyuanEntity>().in("houqinrenyuan_phone", seachFields.get("houqinrenyuanPhone")));
                        if(houqinrenyuanEntities_houqinrenyuanPhone.size() >0 ){
                         ...
                         //后勤人员身份证号
                        List<HouqinrenyuanEntity> houqinrenyuanEntities_houqinrenyuanIdNumber = houqinrenyuanService.selectList(new EntityWrapper<HouqinrenyuanEntity>().in("houqinrenyuan_id_number", seachFields.get("houqinrenyuanIdNumber")));
