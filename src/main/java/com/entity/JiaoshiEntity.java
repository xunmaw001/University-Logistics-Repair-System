...
public class JiaoshiEntity<T> implements Serializable {
     ...
     * 教学楼
     */
    @TableField(value = "jiaoxuelou_types")

    private Integer jiaoxuelouTypes;
	 ...
	 * 设置：教学楼
	 */
    public Integer getJiaoxuelouTypes() {
        return jiaoxuelouTypes;
    }
    /**
	 * 获取：教学楼
	 */

    public void setJiaoxuelouTypes(Integer jiaoxuelouTypes) {
        this.jiaoxuelouTypes = jiaoxuelouTypes;
    }
    /**
	 * 设置：教室编号
	 */
    ...
    public String toString() {
        return "Jiaoshi{" +
            "id=" + id +
            ", jiaoxuelouTypes=" + jiaoxuelouTypes +
