...
public class HouqinrenyuanEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Houqinrenyuan{" +
            "id=" + id +
            ", username=" + username +
            ", password=" + password +
            ", gongsiTypes=" + gongsiTypes +
            ", houqinrenyuanName=" + houqinrenyuanName +
            ", houqinrenyuanPhone=" + houqinrenyuanPhone +
            ", houqinrenyuanIdNumber=" + houqinrenyuanIdNumber +
            ", houqinrenyuanPhoto=" + houqinrenyuanPhoto +
            ", sexTypes=" + sexTypes +
            ", houqinrenyuanEmail=" + houqinrenyuanEmail +
